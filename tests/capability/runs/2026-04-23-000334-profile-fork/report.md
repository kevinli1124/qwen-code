# Run 2026-04-23-000334 · profile-fork
...
| T2.4 | L2    | PASS    | 8/12  | while=true temp=true tradeoff=false                |
...
| T5.3 | L5    | PASS    | 9/12  | read=true pool=true timeout=true suggestion=true   |
| T5.2 | L5    | FAIL    | 6/12  | grep=true reads=1 tools=3                          |
